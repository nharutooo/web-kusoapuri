<x-app-layout>
    ...
    <div class="py-12 bg-gradient-to-br from-slate-50 via-white to-rose-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
            ...
            <div class="bg-white/95 dark:bg-gray-900/85 backdrop-blur shadow-lg sm:rounded-2xl border border-white/70 dark:border-gray-800">
                <div class="p-10 sm:p-12 text-center space-y-10">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <a
                            href="{{ route('hayaoshi.tutorial') }}"
                            class="w-full h-full mx-auto min-h-44 sm:min-h-48 rounded-3xl border border-rose-200 dark:border-rose-800 bg-rose-50 dark:bg-rose-950 px-8 py-12 shadow-sm hover:shadow-lg transition hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-rose-300 dark:focus:ring-rose-700 flex flex-col items-center justify-center text-center"
                        >
                            <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">チュートリアル</p>
                        </a>

                        <a
                            href="{{ route('hayaoshi.main') }}"
